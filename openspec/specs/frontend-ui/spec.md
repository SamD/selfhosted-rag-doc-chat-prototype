...
The frontend UI capability provides a single-page chat interface built with Astro v6, Tailwind v4, and daisyUI. It communicates with the backend API for health checks and query submission, supports 11 daisyUI themes with a theme picker, and renders LLM citations as clickable source links.
