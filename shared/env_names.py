...
ENV_TEMPORAL_SERVER_URL = "TEMPORAL_SERVER_URL"  # Legacy: use TEMPORAL_HOST/TEMPORAL_PORT instead
ENV_TEMPORAL_WHISPER_TASK_QUEUE = "TEMPORAL_WHISPER_TASK_QUEUE"
ENV_USE_TEMPORAL_WHISPER = "USE_TEMPORAL_WHISPER"
ENV_TEMPORAL_HOST = "TEMPORAL_HOST"  # Remote Temporal server host (default: localhost)
ENV_TEMPORAL_PORT = "TEMPORAL_PORT"  # Remote Temporal server gRPC port (default: 7233)
